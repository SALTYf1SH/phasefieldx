...
# For this, we use the cross-platform visualization module.
from phasefieldx.PostProcessing.visualization import plot_vtu

try:
    vtu_file_path = os.path.join(Data.results_folder_name, "paraview-solutions_vtu", "phasefieldx_p0_000009.vtu")
    # Use the cross-platform visualization module with auto backend selection
    plot_vtu(vtu_file_path, scalars='u', cpos='xy', show_scalar_bar=True, show_edges=False,
             title="Displacement Field")
except Exception as e:
    print(f"Skipping 3D visualization due to error: {e}")
    print("You can view the VTU files using ParaView or another VTK viewer.")
...
try:
    ...
    plt.savefig(os.path.join(Data.results_folder_name, "displacement_vs_reaction.png"))
    print(f"Plot saved to {os.path.join(Data.results_folder_name, 'displacement_vs_reaction.png')}")
